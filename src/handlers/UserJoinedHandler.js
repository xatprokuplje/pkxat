...
export default {
    ...
    async execute(bot, packet) {
        ...
        // Samo GLAVNI nalog (bot.state.isPrimary) šalje pozdravnu poruku.
        // Bez ovoga bi svaki nalog u chatu poslao svoj pozdrav istom
        // korisniku, pošto svi slušaju isti "u" paket i dele ista podešavanja.
        if (!bot.state.isPrimary) return;
